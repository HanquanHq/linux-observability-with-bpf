...
bpf.attach_uprobe(name = "./hello-bpf", sym = "main.Programmer.GetWeight", fn_name = "trace_start_time")
bpf.attach_uretprobe(name = "./hello-bpf", sym = "main.Programmer.GetWeight", fn_name = "print_duration")
bpf.trace_print()
